...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <link rel="stylesheet" href="{{ asset('css/default/style.min.css') }}" type="text/css"/>
    <link rel="stylesheet" href="{{ asset('css/bootstrap-select.css') }}" type="text/css"/>
    <link rel="stylesheet" href="{{ asset('css/jquery.dataTables.min.css') }}" type="text/css"/>
    <link rel="stylesheet" href="{{ asset('css/responsive.dataTables.min.css') }}" type="text/css"/>
    <link rel="stylesheet" href="{{ asset('css/dataTables.checkboxes.css') }}" type="text/css"/>
    ...
    <script type="text/javascript" src="{{ asset('js/dataTables.checkboxes.js') }}"></script>
    <script type="text/javascript" src="{{ asset('js/title-numerique.js') }}"></script>
    <script type="text/javascript" src="{{ asset('js/vsf_font.js') }}"></script>
    <script type="text/javascript" src="{{ asset('js/button.html5.min.js') }}"></script>
...
<div class="wthree-copyright">
 <p>© 2017 Visitors. All rights reserved | Design by <a href="#">WOONISHOP</a></p>
</div>
</div>
<!-- / footer -->
</section>
